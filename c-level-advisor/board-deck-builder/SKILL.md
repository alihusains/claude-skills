...
description: "Board deck builder agent skill. This MCP plugin and Claude Code workflow assembles comprehensive board decks. Compatible with Codex and Gemini CLI."
license: MIT
metadata:
  version: 1.0.0
