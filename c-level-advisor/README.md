...
npx ai-agent-skills install alihusains/claude-skills/c-level-advisor

# Install to Claude Code only
npx ai-agent-skills install alihusains/claude-skills/c-level-advisor --agent claude

# Install to Cursor only
npx ai-agent-skills install alihusains/claude-skills/c-level-advisor --agent cursor
```
...
```bash
# CEO Advisor
npx ai-agent-skills install alihusains/claude-skills/c-level-advisor/ceo-advisor

# CTO Advisor
npx ai-agent-skills install alihusains/claude-skills/c-level-advisor/cto-advisor
```
