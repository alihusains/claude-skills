...
<span class="meta-badge">:material-github: <a href="https://github.com/alihusains/claude-skills/tree/main/agents/marketing/cs-content-creator.md">Source</a></span>
</div>
...
**Skill Location:** [`marketing-skill/content-creator`](https://github.com/alihusains/claude-skills/tree/main/marketing-skill/content-creator)
...
1. **Brand Guidelines**
   - **Location:** [`references/brand_guidelines.md`](https://github.com/alihusains/claude-skills/tree/main/marketing-skill/content-creator/references/brand_guidelines.md)
...
2. **Content Frameworks**
   - **Location:** [`references/content_frameworks.md`](https://github.com/alihusains/claude-skills/tree/main/marketing-skill/content-creator/references/content_frameworks.md)
...
3. **Social Media Optimization**
   - **Location:** [`references/social_media_optimization.md`](https://github.com/alihusains/claude-skills/tree/main/marketing-skill/content-creator/references/social_media_optimization.md)
...
4. **Analytics Guide**
   - **Location:** [`references/analytics_guide.md`](https://github.com/alihusains/claude-skills/tree/main/marketing-skill/content-creator/references/analytics_guide.md)
...
1. **Content Calendar Template**
   - **Location:** [`assets/content_calendar_template.md`](https://github.com/alihusains/claude-skills/tree/main/marketing-skill/content-creator/assets/content_calendar_template.md)
...
- **Skill Documentation:** [../../marketing-skill/content-creator/SKILL.md](https://github.com/alihusains/claude-skills/tree/main/marketing-skill/content-creator/SKILL.md)
