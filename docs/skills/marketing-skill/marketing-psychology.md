...
<span class="meta-badge">:material-github: <a href="https://github.com/alihusains/claude-skills/tree/main/marketing-skill/marketing-psychology/SKILL.md">Source</a></span>
</div>
...
The full catalog lives in [references/mental-models-catalog.md](https://github.com/alihusains/claude-skills/tree/main/marketing-skill/marketing-psychology/references/mental-models-catalog.md). Load it when you need to look up specific models or browse the full list.
