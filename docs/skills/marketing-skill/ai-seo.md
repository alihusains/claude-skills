...
<span class="meta-badge">:material-github: <a href="https://github.com/alihusains/claude-skills/tree/main/marketing-skill/ai-seo/SKILL.md">Source</a></span>
</div>
...
See [references/ai-search-landscape.md](https://github.com/alihusains/claude-skills/tree/main/marketing-skill/ai-seo/references/ai-search-landscape.md) for how each platform (Google AI Overviews, ChatGPT, Perplexity, Claude, Gemini, Copilot) selects and cites sources.
...
See [references/content-patterns.md](https://github.com/alihusains/claude-skills/tree/main/marketing-skill/ai-seo/references/content-patterns.md) for ready-to-use templates for each pattern.
...
See [references/monitoring-guide.md](https://github.com/alihusains/claude-skills/tree/main/marketing-skill/ai-seo/references/monitoring-guide.md) for the full tracking setup and templates.
