...
<span class="meta-badge">:material-github: <a href="https://github.com/alihusains/claude-skills/tree/main/marketing-skill/paid-ads/SKILL.md">Source</a></span>
</div>
...
**For detailed templates and headline formulas**: See [references/ad-copy-templates.md](https://github.com/alihusains/claude-skills/tree/main/marketing-skill/paid-ads/references/ad-copy-templates.md)
...
**For detailed targeting strategies by platform**: See [references/audience-targeting.md](https://github.com/alihusains/claude-skills/tree/main/marketing-skill/paid-ads/references/audience-targeting.md)
...
**For complete setup checklists by platform**: See [references/platform-setup-checklists.md](https://github.com/alihusains/claude-skills/tree/main/marketing-skill/paid-ads/references/platform-setup-checklists.md)
...
For implementation, see the [tools registry](https://github.com/alihusains/claude-skills/tree/main/tools/REGISTRY.md). Key advertising platforms:

| Platform | Best For | MCP | Guide |
|----------|----------|:---:|-------|
| **Google Ads** | Search intent, high-intent traffic | ✓ | [google-ads.md](https://github.com/alihusains/claude-skills/tree/main/tools/integrations/google-ads.md) |
| **Meta Ads** | Demand gen, visual products, B2C | - | [meta-ads.md](https://github.com/alihusains/claude-skills/tree/main/tools/integrations/meta-ads.md) |
| **LinkedIn Ads** | B2B, job title targeting | - | [linkedin-ads.md](https://github.com/alihusains/claude-skills/tree/main/tools/integrations/linkedin-ads.md) |
| **TikTok Ads** | Younger demographics, video | - | [tiktok-ads.md](https://github.com/alihusains/claude-skills/tree/main/tools/integrations/tiktok-ads.md) |

For tracking, see also: [ga4.md](https://github.com/alihusains/claude-skills/tree/main/tools/integrations/ga4.md), [segment.md](https://github.com/alihusains/claude-skills/tree/main/tools/integrations/segment.md)
