...
<span class="meta-badge">:material-github: <a href="https://github.com/alihusains/claude-skills/tree/main/marketing-skill/paywall-upgrade-cro/SKILL.md">Source</a></span>
</div>
...
**For comprehensive experiment ideas**: See [references/experiments.md](https://github.com/alihusains/claude-skills/tree/main/marketing-skill/paywall-upgrade-cro/references/experiments.md)
