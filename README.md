...
[![Stars](https://img.shields.io/github/stars/alihusains/claude-skills?style=flat)](https://github.com/alihusains/claude-skills/stargazers)
[![Forks](https://img.shields.io/github/forks/alihusains/claude-skills?style=flat)](https://github.com/alihusains/claude-skills/network/members)
[![Contributors](https://img.shields.io/github/contributors/alihusains/claude-skills?style=flat)](https://github.com/alihusains/claude-skills/graphs/contributors)
...
- **Unified Logic** — Consistently route all complex tasks through **RFC-Driven DAG orchestration (Ralphinho)** for parallel execution.
- **Hook reliability overhaul** — Added `hooks/memory-persistence/` for robust lifecycle state management, and script-based hooks replacing fragile inline one-liners.
- **New harness commands** — Fully implemented `/harness-audit`, `/verify` (unified for 7+ languages), `/eval`, `/checkpoint`, `/security-scan`, and `/model-route`.
- **New performance skills** — `eval-harness`, `cost-aware-llm-pipeline`, `security-review`, `continuous-learning-v2`, and `strategic-compact`.
- **Token Efficiency** — New `docs/token-optimization.md` and `/model-route` heuristics for cost-effective agent deployments.
- **100% scorecard** — Reached a perfect 70/70 on the deterministic repo harness audit.
