...
description: "Autonomous experiment loop that optimizes files by metrics. This MCP plugin and agent skill for Claude Code runs continuous workflows. Supports Cursor, Codex, and Gemini CLI."
license: MIT
metadata:
  version: 2.0.0
