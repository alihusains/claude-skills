...
description: "Secrets vault manager agent skill. This MCP plugin and Claude Code workflow configures HashiCorp Vault and cloud secret stores. Compatible with Codex and Gemini CLI."
---
