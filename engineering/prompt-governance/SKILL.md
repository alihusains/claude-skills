...
description: "Prompt governance agent skill. This MCP plugin and Claude Code workflow tests prompts, manages versions, and builds registries. Compatible with Codex and Gemini CLI."
---
