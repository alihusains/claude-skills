...
description: "Docker development agent skill. This MCP plugin and Claude Code workflow optimizes Dockerfiles, orchestrates compose, and hardens security. Compatible with Codex and Gemini CLI."
license: MIT
metadata:
  version: 1.0.0
