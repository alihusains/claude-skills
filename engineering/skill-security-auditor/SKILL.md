...
description: "Skill security auditor agent skill. This MCP plugin and Claude Code workflow scans code for vulnerabilities and malware. Compatible with Codex and Gemini CLI."
---
